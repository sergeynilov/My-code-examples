...
class Author extends Model implements HasMedia
{
    ...
    public static function getAuthorValidationRulesArray(int $authorId = null, array $skipFieldsArray = []): array
    {
        ...
        $authorAvatarUploadingRules = new RulesImageUploading(UploadImageRules::UIR_AUTHOR_AVATAR);
        $authorAvatarRules          = $authorAvatarUploadingRules->getRules();
        ...
        $validationRulesArray = Arr::add($validationRulesArray, 'avatar', $authorAvatarRules);
    ...
    public static function getValidationMessagesArray(): array
    {
        ...
        return [
            ...
            'avatar.max'          => 'Selected avatar is too big in size. It exceeds avatar size limit in ' .
                                     getCFFileSizeAsString($uploadedFileMaxMib * 1024/** 1024*/),
