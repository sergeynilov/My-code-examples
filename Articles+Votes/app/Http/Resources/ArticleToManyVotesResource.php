...
class ArticleToManyVotesResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'pivot_created_at_formatted' => DateConv::getFormattedDateTime($pivotData['created_at']),
            'pivot_updated_at_formatted' => DateConv::getFormattedDateTime($pivotData['updated_at']),
            'pivot_expired_at_formatted' => DateConv::getFormattedDateTime($pivotData['expired_at']),
        ];
